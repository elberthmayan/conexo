...
const Feed = {
    ...
    simulatedStories: {
        'ana': [
            { id: 'ana1', type: 'image', src: 'https://images.unsplash.com/photo-15235281824-360181454366?q=80&w=400&auto=format&fit=crop', caption: 'Dia incrível na montanha! ⛰️', timestamp: '1h' },
            { id: 'ana2', type: 'video', src: 'https://www.w3schools.com/html/mov_bbb.mp4', caption: 'Pôr do sol perfeito! 🌅', timestamp: '3h' }
        ],
        'carlos': [
            { id: 'carlos1', type: 'image', src: 'https://images.unsplash.com/photo-1550745165-9bc0b252726a?q=80&w=400&auto=format&fit=crop', caption: 'Novo setup gamer! 🎮', timestamp: '2h' }
        ]
    },
    currentStoryIndex: 0,
    ...
    openStoryViewer(userId) {
        ...
        if (userId === 'you') {
            ...
            userAvatar = 'https://placehold.co/40x40/5e5ce5/white?text=U'; // Seu avatar
            userName = 'Você';
        } else {
            ...
            this.posts = [
                {
                    ...
                    likes: 15,
                    comments: [
                        { user: 'Você', avatar: 'https://placehold.co/32x32/5e5ce5/white?text=U', text: 'Adorei essa música!', time: '5m' },
                        { user: 'Ana Livia', avatar: 'https://placehold.co/32x32/e55c5c/white?text=A', text: 'Vibe perfeita para codar!', time: '2m' }
                    ]
                },
                {
                    id: 'post-text-1',
                    type: 'text',
                    user: 'Ana Livia',
                    avatar: 'https://placehold.co/40x40/e55c5c/white?text=A',
                    time: '2h',
                    content: 'Explorando o novo design da plataforma! Achei super futurista e clean. O que vocês acharam do modo escuro? 🚀',
                    likes: 28,
                    comments: [
                        { user: 'Marcos Vale', avatar: 'https://placehold.co/32x32/5ce58a/white?text=M', text: 'Ficou show! Curti demais o dark mode.', time: '10m' }
                    ]
                }
            ];
        }
    ...
    createPostFromInput() {
        ...
        const postData = {
            ...
            type: 'text',
            user: 'Você',
            avatar: 'https://placehold.co/40x40/5e5ce5/white?text=U',
            time: 'agora',
            content: text,
            likes: 0,
...
const Explore = {
    ...
    users: [
        { id: 'ana', name: 'Ana Livia', bio: 'Desenvolvedora Web | UI/UX Designer', avatar: 'https://placehold.co/100x100/e55c5c/white?text=A', isFollowing: false },
        { id: 'marcos', name: 'Marcos Vale', bio: 'Engenheiro de Software | Entusiasta de IA', avatar: 'https://placehold.co/100x100/5ce58a/white?text=M', isFollowing: true },
        { id: 'carlos', name: 'Carlos Souza', bio: 'Criador de Conteúdo | Gamer', avatar: 'https://placehold.co/100x100/3e92e8/white?text=C', isFollowing: false },
        { id: 'juliana', name: 'Juliana Reis', bio: 'Fotógrafa | Viajante', avatar: 'https://placehold.co/100x100/e8c53e/white?text=J', isFollowing: false }
    ],
...
const Notifications = {
    ...
    initialNotifications: [
        { id: '1', type: 'follow', user: 'Ana Livia', avatar: 'https://placehold.co/40x40/e55c5c/white?text=A', message: 'começou a seguir você.', isNew: true, actionBtn: { text: 'Seguir de volta', class: 'btn-primary', action: 'follow-back' } },
        { id: '2', type: 'like', user: 'Marcos Vale', avatar: 'https://placehold.co/40x40/5ce58a/white?text=M', message: 'curtiu sua foto.', isNew: true, postThumb: 'https://images.unsplash.com/photo-1542158399-885435b64234?q=80&w=100&auto=format&fit=crop', actionBtn: { text: 'Ver Publicação', class: 'btn-secondary', action: 'view-post' } },
        { id: '3', type: 'comment', user: 'Juliana Reis', avatar: 'https://placehold.co/40x40/e8c53e/white?text=J', message: 'comentou: "Que lugar incrível! 🤩"', isNew: false, postThumb: 'https://images.unsplash.com/photo-1542158399-885435b64234?q=80&w=100&auto=format&fit=crop', actionBtn: { text: 'Responder', class: 'btn-primary', action: 'reply-comment' } },
        { id: '4', type: 'suggestion', user: 'Carlos Souza', avatar: 'https://placehold.co/40x40/3e92e8/white?text=C', message: 'Você talvez conheça <strong>Carlos Souza</strong>.', isNew: false, actionBtn: { text: 'Seguir', class: 'btn-primary', action: 'follow' } },
        { id: '5', type: 'community-invite', user: 'Retrô Gaming', avatar: 'https://placehold.co/40x40/7c2d12/white?text=R', message: 'Você foi convidado para a comunidade <strong>Retrô Gaming</strong>.', isNew: true, actionBtn: { text: 'Aceitar', class: 'btn-primary', action: 'accept-community' } },
        { id: '6', type: 'mention', user: 'Synthwave Lover', avatar: 'https://placehold.co/40x40/9d9dff/white?text=S', message: 'mencionou você em uma publicação.', isNew: false, actionBtn: { text: 'Ver Publicação', class: 'btn-secondary', action: 'view-post' } },
        { id: '7', type: 'event', user: 'Emanuel', avatar: 'imagens/emanuel.jpeg', message: 'Lembrete: Sua aula de <strong>"Programação do Zero ao Avançado"</strong> começa em 30 minutos.', isNew: true, actionBtn: { text: 'Ver Detalhes', class: 'btn-secondary', action: 'view-details' } },
        { id: '8', type: 'system', user: 'Conectare Suporte', avatar: 'https://placehold.co/40x40/65676b/white?text=S', message: 'Sua senha foi alterada com sucesso. Se não foi você, entre em contato.', isNew: true, actionBtn: { text: 'Ajuda', class: 'btn-secondary', action: 'get-help' } }
    ],
    ...
    startSimulatedNewNotifications() {
        ...
        const newSimulatedNotifications = [
            { type: 'like', user: 'Gabriel S.', avatar: 'https://placehold.co/40x40/ff7f50/white?text=G', message: 'curtiu sua foto mais recente.', postThumb: 'https://images.unsplash.com/photo-1516339901601-2e1b62dc0c45?q=80&w=100&auto=format&fit=crop' },
